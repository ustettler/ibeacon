...
export default class BeaconScreen extends Component {
  ...
  scanAndConnect() {
    this.manager.startDeviceScan(null, null, (error, device) => {
      console.log(":::::::::::Scan And Connect::::::::::, BEACON_UUID");
...
if (device != null) { 
  ...
  callPushNotification = () =>{
    PushNotification.localNotification({
      ...
      // Notification don´t show on the Screen = true
      autoCancel: false,
      largeIcon: 'ic_launcher', 
      smallIcon: 'ic_notification',
      bigText: 'Haben Sie die Tür abgeschlossen? Bitte schließen Sie die Tür ab, bevor Sie das Haus verlassen', // (optional) default: "message" prop
      color: 'red', 
      vibrate: true, 
      vibration: 300, 
      tag: 'some_tag', 
      ...
      subtitle: "Schliess-Erinnerung!", // (optional) smaller title below notification title

      /* iOS and Android properties */
      id: 1, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
      title: 'ReAlert Lock Reminder', // (optional)
      message: 'Hast du die Tür abgeschlossen? Bitte schließen die Tür ab, bevor du das Haus verlässen', // (required)
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.top}>
            <View style={styles.itemRow}>
              <Item bg={"#1B3766"} wd={43.5} label={"Beacon gefunden"} count={this.state.rssi > 0 ? "YES" : "NO"} icon={require('../assets/images/wifi.png')} />
              <Item bg={"#475CE1"} wd={43.5} label={"Entfernung"} count={`${this.state.rssi} m`} icon={require('../assets/images/distance.png')} />
            </View>
          </View>
